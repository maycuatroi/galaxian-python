...
class WarZone:
    def __init__(self, destination, max_viruses = 10):
        ...
        self.virus = ImageRegistry().get_images('data/asteroid_1_')
        self.bacterias  = game.common.load_images('data/bacterias_1_')
...
class Game:
    def __init__(self, screen):
        ...
        self.player = game.player.Ship(self.__playground,         
                                       self.pshots.create)
        self.viruses = WarZone(self.__playground)
    ...
    def run(self):
        ...
        while 1:
            ...
            self.space.update()
            self.pshots.update()
            self.viruses.update(self.pshots)
            self.player.update()
